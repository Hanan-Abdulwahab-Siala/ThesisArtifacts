...
{ private Vector values; 
  ...
  { String nme = getName(); 
    ...
    { return elementType != null && elementType.isMultiple(); } 
    return false; 
  } 
  ...
  public static Type getEcoreType(String etype, Vector types)  
  { if (etype == null) 
    { return null; } 
  ...
  { 
    ...
    { return typeCompatible(elemt1, elemt1, elemt2, elemt2); }   
	if (t1.isCollection() && !t2.isCollection())
	{ return typeCompatible(elemt1,elemt1,t2,elemt2); }  
	if (t1.isEntity() && t2.isEntity())
	{ return Entity.isDescendant(t1.entity,t2.entity); }  
	if (t1.isEntity() && t2.isString())  
