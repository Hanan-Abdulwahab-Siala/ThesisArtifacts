...
parser.add_argument('--train_data', type=str, default='../tree2tree_dataset/For2Lam/small/preprocessed_progs_train.json',
                    help='training data')
parser.add_argument('--val_data', type=str, default='../tree2tree_dataset/For2Lam/small/preprocessed_progs_valid.json',
                    help='training data')
parser.add_argument('--test_data', type=str, default='../tree2tree_dataset/For2Lam/small/preprocessed_progs_test.json',
                    help='test data')
